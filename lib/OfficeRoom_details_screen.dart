...
// }
  ...
  Widget _buildProgressLine(int step) {
    return Container(
      width: 40,
      height: 2,
      color: _currentStep > step ? _colorScheme[0] : Colors.grey[300],
    );
  }
    ...
    return Column(
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            fontSize: 12,
            color: isCurrent ? _colorScheme[0] : _colorScheme[3],
                ...
                children: [
                  Expanded(
                    child: OutlinedButton(
                      ...
                      style: OutlinedButton.styleFrom(
                        ...
                        side: BorderSide(color: _colorScheme[0]),
                      ...
                      child: Text(
                        'Back',
                        style: TextStyle(color: _colorScheme[0]),
                      ),
                    ),
                  ),
                  const SizedBox(width: 16),
                  Expanded(
                    child: ElevatedButton(
                      onPressed: _nextStep,
                      style: ElevatedButton.styleFrom(
                        backgroundColor: _colorScheme[0],
                        padding: const EdgeInsets.symmetric(vertical: 14),
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(8),
                        ),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(
                icon,
                color: isSelected ? _colorScheme[0] : Colors.grey[600],
              ),
            ),
            const SizedBox(width: 16),
            Expanded(
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _colorScheme[0],
                      padding: const EdgeInsets.symmetric(vertical: 14),
                      disabledBackgroundColor: _colorScheme[0].withOpacity(0.5),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(8),
                      ),
                    ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.event, color: _colorScheme[0], size: 20),
              const SizedBox(width: 8),
              Text(
                'Reservation Details',
                style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.payment, color: _colorScheme[0], size: 20),
              const SizedBox(width: 8),
              Text(
                'Payment Details',
                style: TextStyle(
          ...
          if (paymentMethod == 'points')
            Container(
              ...
              padding: const EdgeInsets.all(12),
              decoration: BoxDecoration(
                color: _colorScheme[0].withOpacity(0.1),
                borderRadius: BorderRadius.circular(8),
              ),
              child: Row(
                children: [
                  Icon(Icons.info_outline, size: 18, color: _colorScheme[0]),
                  const SizedBox(width: 8),
                  Expanded(
                    child: Text(
